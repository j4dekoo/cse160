...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // For 2d vectors
        if(isNaN(other1.elements[2]) || isNaN(other2.elements[2]) || other1.elements[2] == 0 || other2.elements[2] == 0){
          v3.elements[0] = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
        }
